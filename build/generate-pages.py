...
PAGES = {
    ...
    "kg": {
        ...
        "invite.text": (
            "<p>Сиздерди балдарыбыздын үйлөнүү үлпөтүнө арналган салтанаттуу кечеге чың дилибиздең чакырабыз.</p>"
            "<p>Өмүрдөгү эң унутулгус күндөрдүн биринде жакындарыбыз жана кадырлуу конокторубуз менен бирге болуп, "
            "бул кубанычтуу күндү Сиздер менен бөлүшүүнү чың жүрөктөн каалайбыз.</p>"
