...
PAGES = {
    "ru": {
        ...
        "events.message": (
            ...
            "и особенными моментами. Самые важные и трогательные события начнутся с первых минут торжества. "
    ...
    "kg": {
        ...
        "events.message": (
            ...
            "<p>Сиздер үчүн эстен кеткис, кубанычка, жагымдуу сюрприздерге жана өзгөчө көз ирмемдерге бай кече даярдадык. "
            "Майрамыбыздын эң маанилүү жана таасирдүү учурлары алгачкы мүнөттөрдөн тартып башталат. "
