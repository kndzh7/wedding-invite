...
PAGES = {
    "ru": {
        ...
        "ru_active": " active",
        "kg_active": "",
        "seo.title": "Эльдияр & Жамиля - приглашение на свадьбу",
        ...
        "seo.og_title": "Эльдияр & Жамиля - приглашение на свадьбу",
    ...
    "kg": {
        ...
        "invite.text": (
            "<p>Сиздерди балдарыбыздын үйлөнүү үлпөтүнө арналган салтанаттуу кечеге чын дилибизден чакырабыз.</p>"
